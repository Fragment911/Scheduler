...
INSERT INTO `schedule` (`name`, `account_id`) VALUES ("University", 2);
INSERT INTO `schedule` (`name`, `account_id`) VALUES ("Wedding", 2);
...
INSERT INTO `task` (`name`, `text`, `status`, `schedule_id`) VALUES ("Exam", "Pass exam", "IN_PROCESS", "3");
INSERT INTO `task` (`name`, `text`, `status`, `schedule_id`) VALUES ("Ring", "Buy ring", "IN_PROCESS", "4");
INSERT INTO `task` (`name`, `text`, `status`, `schedule_id`) VALUES ("Work", "Find work", "IN_PROCESS", "5");
INSERT INTO `task` (`name`, `text`, `status`, `schedule_id`) VALUES ("Test", "Do test", "IN_PROCESS", "5");
